...
# Title:           gen_sin.py
#
# Description:     Generates coefficients for 1/4 cosine lookup table. Ouput in
...
#
#                  Simply replace np.cos(t) with np.sin(t) if a 1/4 cos LUT
#                  is desired.
#
################################################################################
...
cos = [hex(int(np.floor(item*(2**RAM_width)))) for item in cos]
